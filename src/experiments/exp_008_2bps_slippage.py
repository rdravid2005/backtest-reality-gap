...
EXP-006_QQQ_ORB_5M_5BPS_SLIPPAGE

This experiment adds 5 basis points of slippage per order to the baseline
QQQ 5-minute ORB strategy.

The goal is to test how much a small adverse fill assumption damages a
high-turnover intraday strategy.
"""
...
class BacktestRealityGap(QCAlgorithm):
    ...
    def initialize(self):
        ...
        security.set_slippage_model(ConstantSlippageModel(0.0002))
